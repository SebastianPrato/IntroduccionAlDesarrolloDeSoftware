...
def obtener_alumno(padron):
    if padron == 1:
        return {"padron:":"1", "nombre":"luis", "apellido":"Huergo"}
    return None

def obtener_materias_alumno(padron):
    return[
        {"codigo": "CB001", "materia": "Análisis Matemático II", "nota": "7", "fecha": "2025-02-24"},
        {"codigo": "CB002", "materia": "Algebra Lineal", "nota": "7", "fecha": "2024-12-12"},
        {"codigo": "TB021", "materia": "Fundamentos de la Programación", "nota": "7", "fecha": "2024-12-05"},
    ]

def agregar_nota(padron, codigo, nota, fecha):
    print(f"MOCK: agregando nota para {padron}, {codigo}, {nota}, {fecha}")
    return True

def obtener_alumnos_materia(codigo):
    return[
        {"padron:":"1", "nombre":"luis", "apellido":"Huergo"},
        {"padron:":"111619", "nombre":"Pers", "apellido":"Prato"}
    ]
